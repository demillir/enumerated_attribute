...
Gem::Specification.new do |s|
  ...
  s.authors = ["Jeff Patmon", "Ben Hutton", "Dan Milliron"]
  s.date = %q{2011-07-08}
  s.description = %q{Enumerated model attributes and view helpers}
  s.email = %q{dan@railsblazer.com}
  s.homepage = %q{http://github.com/demillir/enumerated_attribute/tree/master}
  s.require_paths = ["lib"]
  s.rubygems_version = %q{1.3.7}
  s.summary = %q{Add enumerated attributes to your models and expose them in drop-down lists in your views}
  s.test_files = ["spec/poro_spec.rb", "spec/new_and_method_missing_spec.rb", "spec/inheritance_spec.rb"]
